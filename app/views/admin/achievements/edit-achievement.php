<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-2xl font-semibold text-zinc-900">Başarı Düzenle</h1>
        <p class="text-sm text-zinc-500 mt-1">Başarı bilgilerini güncelleyin</p>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2">
        <div class="shadcn-card">
            <form action="<?php echo URLROOT; ?>/admin/achievements/editAchievement/<?php echo $achievement->id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="category" name="category" class="shadcn-input" required>
                            ...
                            <option value="Şampiyonluk" <?php echo ($achievement->category == 'Şampiyonluk') ? 'selected' : ''; ?>>Şampiyonluk</option>
                            <option value="Kupa" <?php echo ($achievement->category == 'Kupa') ? 'selected' : ''; ?>>Kupa</option>
                            <option value="Turnuva" <?php echo ($achievement->category == 'Turnuva') ? 'selected' : ''; ?>>Turnuva</option>
                            <option value="Ödül" <?php echo ($achievement->category == 'Ödül') ? 'selected' : ''; ?>>Ödül</option>
                            <option value="Diğer" <?php echo ($achievement->category == 'Diğer') ? 'selected' : ''; ?>>Diğer</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if (!empty($achievement->image)): ?>
                            <div class="mb-3">
                                ...
                                <img src="<?php echo URLROOT; ?>/<?php echo htmlspecialchars($achievement->image); ?>" 
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                name="sort_order" 
                                class="shadcn-input" 
                                value="<?php echo htmlspecialchars($achievement->sort_order); ?>"
                                min="0"
                            >
                        ...
                        <div>
                            ...
                            <select id="status" name="status" class="shadcn-input">
                                <option value="active" <?php echo ($achievement->status == 'active') ? 'selected' : ''; ?>>Aktif</option>
                                <option value="inactive" <?php echo ($achievement->status == 'inactive') ? 'selected' : ''; ?>>Pasif</option>
                            </select>
                        </div>
                    </div>
                </div>
