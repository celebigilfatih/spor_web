<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-2xl font-semibold text-zinc-900">Yeni Efsane Ekle</h1>
        <p class="text-sm text-zinc-500 mt-1">Kulübün efsane oyuncuları listesine yeni efsane ekleyin</p>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2">
        <div class="shadcn-card">
            <form action="<?php echo URLROOT; ?>/admin/achievements/createLegend" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="shadcn-input" 
                            required
                            value="<?php echo isset($data['position']) ? htmlspecialchars($data['position']) : ''; ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="shadcn-input" 
                            required
                            value="<?php echo isset($data['years']) ? htmlspecialchars($data['years']) : ''; ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="shadcn-input" 
                            required
                            value="<?php echo isset($data['stats']) ? htmlspecialchars($data['stats']) : ''; ?>"
                    ...
                    <div>
                        ...
                        ><?php echo isset($data['bio']) ? htmlspecialchars($data['bio']) : ''; ?></textarea>
                    ...
                    <div>
                        ...
                        >
                        <p class="text-sm text-zinc-500 mt-1">Oyuncu fotoğrafı (JPG, PNG, max 5MB)</p>
    ...
    <div class="lg:col-span-1">
        <div class="shadcn-card">
            ...
            <div class="space-y-4 text-sm text-zinc-600">
                ...
                <div>
                    <h4 class="font-medium text-zinc-900 mb-1">Biyografi</h4>
                    <p>Oyuncunun kariyer hikayesi, başarıları ve kulübe katkılarını detaylı şekilde anlatın.</p>
                </div>
                <div>
                    <h4 class="font-medium text-zinc-900 mb-1">Fotoğraf</h4>
                    <p>Oyuncunun fotoğrafını yükleyin. Profesyonel ve yüksek kaliteli görsel kullanın.</p>
                </div>
            </div>
        </div>
    </div>
