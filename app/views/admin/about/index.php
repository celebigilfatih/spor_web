...
<div class="shadcn-page-container">
    ...
    <div class="shadcn-page-header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="shadcn-page-title">Hakkımızda Yönetimi</h1>
                <p class="shadcn-page-description">Hakkımızda sayfası bölümlerini yönetin</p>
            </div>
            <a href="' . BASE_URL . '/admin/about/create" class="shadcn-btn shadcn-btn-primary">
    ...
    <div class="shadcn-card">
        <div class="shadcn-card-header">
            <h3 class="shadcn-card-title">Bölümler</h3>
            <p class="shadcn-card-description">Tüm hakkımızda bölümleri</p>
        </div>
                ...
                <table class="shadcn-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 35%;">İçerik Önizleme</th>
    ...
    if (isset($sections) && is_array($sections) && count($sections) > 0) {
        foreach ($sections as $section) {
            $statusClass = $section['status'] === 'active' ? 'shadcn-badge-success' : 'shadcn-badge-secondary';
            $statusText = $section['status'] === 'active' ? 'Aktif' : 'Pasif';
            
            // Strip HTML and limit content preview
            $contentPreview = strip_tags($section['content']);
            ...
            $content .= '
                        <tr>
                            ...
                            <td class="text-sm text-zinc-600">' . htmlspecialchars($contentPreview) . '</td>
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <a href="' . BASE_URL . '/admin/about/edit/' . $section['id'] . '" 
                                    ...
                                    <button type="button" 
                                            onclick="deleteSection(' . $section['id'] . ', \'' . htmlspecialchars($section['title']) . '\')" 
        ...
        $content .= '
                        <tr>
                            <td colspan="7" class="text-center py-8 text-zinc-500">
                                ...
                                <p class="text-lg font-medium">Henüz bölüm eklenmemiş</p>
                                <p class="text-sm mt-2">Yeni bölüm eklemek için yukarıdaki butonu kullanın</p>
                            </td>
                        </tr>';
    }
...
<div id="deleteModal" class="shadcn-modal" style="display: none;">
    ...
    <div class="shadcn-modal-content">
        <div class="shadcn-modal-header">
            <h3 class="shadcn-modal-title">Bölümü Sil</h3>
        ...
        <div class="shadcn-modal-body">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-zinc-600"><strong id="deleteSectionName"></strong> bölümünü silmek istediğinizden emin misiniz?</p>
                </div>
            </div>
        </div>
...
function deleteSection(id, name) {
    ...
    document.getElementById("deleteForm").action = "' . BASE_URL . '/admin/about/delete/" + id;
